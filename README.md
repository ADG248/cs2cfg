...
```
### Additional Notes
- In CS2's Lauch Options, the name of the Config File must go after "+exec". If the .cfg file is named "autoexec.cfg", put "+exec autoexec". You can change the file name if you want.<br/>
